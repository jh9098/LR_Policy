...
세부 규칙:
1) overview에 핵심 메시지/최신 동향, 2) programs[*]에 대상·혜택·서류·절차 한 줄 목록, 3) commonResources에 복지로/정부24/건보공단 등, 4) coreKeywords 배열에는 최소 3개 최대 5개의 핵심키워드를 넣고 각 요소는 한 줄 문자열, 5) progressive/conservative/impactToLife는 null, 6) 모든 문자열 한 줄, 7) 최종 출력은 JSON 한 줄.`};
