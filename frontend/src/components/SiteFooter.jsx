  ...
  return (
    <footer className="border-t border-slate-200 bg-white/90 dark:border-slate-700 dark:bg-slate-900/80">
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
        ...
        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">'ChatGPT의 의견'은 중립 해석 및 생활/시장 영향 요약입니다.</p>
        <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">모든 정리 내용은 참고용이며 법적/투자적 조언이 아닙니다.</p>
      </div>
    </footer>
  );
}
